...
(function (t, e, n) {
  ...
  function o(t, e, a, o) {
    if (
      ...
      if (
        ((t[0] = -1 === t[0].indexOf("%") ? r(e, a + "X", t[0]) : t[0]),
        t[1] === n)
      ) {
  ...
  function i(t, e, n, r, a, o) {
    var i,
      ...
      s,
      c,
      d = u.Util.getCSS(e, t, a);
    if (
      (1 === d.length && ((c = d[0]), (d = []), (d[0] = c), (d[1] = c)),
      -1 !== ("" + d[0]).indexOf("%"))
    )
    ...
    return (
      "auto" === d[1]
        ...
        : -1 !== ("" + d[1]).indexOf("%")
        ? ((s = parseFloat(d[1]) / 100),
          (i = n.height * s),
          "backgroundSize" !== t && (i -= (o || r).height * s))
        : (i = parseInt(d[1], 10)),
      [l, i]
    );
  }
  ...
  (u.Util = {}),
      ...
      var e,
        ...
        f = function () {
          e &&
            ...
            "-" === e.substr(0, 1) &&
              (a = e.indexOf("-", 1) + 1) > 0 &&
              ((r = e.substr(0, a)), (e = e.substr(a))),
            d.push({ prefix: r, method: e.toLowerCase(), value: o, args: s })),
            (s = []),
            (e = r = n = o = "");
        };
      f();
    ...
    (u.Util.OffsetBounds = function (t) {
      var e = t.offsetParent
        ? u.Util.OffsetBounds(t.offsetParent)
        : { top: 0, left: 0 };
      return {
    ...
    (u.Util.Children = function (t) {
      ...
      try {
        ...
        u.Util.log(
          "html2canvas.Util.Children failed with exception: " + r.message
        ),
          (e = []);
      }
      return e;
    ...
    (u.Util.Font = (function () {
      ...
      return function (e, r, a) {
        ...
        return (
          ...
          (l = { baseline: o, lineWidth: 1, middle: i }),
          (t[e + "-" + r] = l),
    ...
    (u.Parse = function (r, a) {
      function o() {
        return Math.max(
          Math.max(de.body.scrollWidth, de.documentElement.scrollWidth),
          Math.max(de.body.offsetWidth, de.documentElement.offsetWidth),
          Math.max(de.body.clientWidth, de.documentElement.clientWidth)
        );
      }
      function i() {
        return Math.max(
          Math.max(de.body.scrollHeight, de.documentElement.scrollHeight),
          Math.max(de.body.offsetHeight, de.documentElement.offsetHeight),
          Math.max(de.body.clientHeight, de.documentElement.clientHeight)
        );
      }
      function c(t, e) {
      ...
      function d(t, e, n, r, a, o) {
        "transparent" !== o &&
          (t.setVariable("fillStyle", o), t.fillRect(e, n, r, a), (ce += 1));
      }
      function h(t, e, r) {
      ...
      function g(t, e, n, r) {
        null !== t &&
          ue.trimText(t).length > 0 &&
          (r.fillText(t, e, n), (ce += 1));
      }
      function m(t, e, r, a) {
        var o = !1,
          i = ge(e, "fontWeight"),
        ...
        return (
          t.setVariable("fillStyle", a),
          t.setVariable(
            "font",
            [ge(e, "fontStyle"), ge(e, "fontVariant"), i, s, l].join(" ")
          ),
          t.setVariable("textAlign", o ? "right" : "left"),
          c.length &&
            (t.setVariable("shadowColor", c[0].color),
      ...
      function b(t, e, n, r, a) {
        var o;
        if (he.rangeBounds && !a)
          ("none" !== n || 0 !== ue.trimText(e).length) &&
            (o = w(e, t.node, t.textOffset)),
      ...
      function w(t, e, n) {
        ...
        return (
          r.setStart(e, n), r.setEnd(e, n + t.length), r.getBoundingClientRect()
        );
      }
      function x(t, e) {
        var n = t.parentNode,
      ...
      function v(t, e, n) {
        ...
        ue.trimText(e.nodeValue).length > 0 &&
          ((e.nodeValue = f(e.nodeValue, ge(t, "textTransform"))),
          (c = c.replace(["-webkit-auto"], ["auto"])),
          (o =
            !a.letterRendering &&
            /^(left|right|justify|auto)$/.test(c) &&
            p(ge(t, "letterSpacing"))
              ? e.nodeValue.split(/(\b| )/)
              : e.nodeValue.split("")),
          (r = m(i, t, s, l)),
          a.chinese &&
            o.forEach(function (t, e) {
              /.*[\u4E00-\u9FA5].*$/.test(t) &&
                ((t = t.split("")), t.unshift(e, 1), o.splice.apply(o, t));
            }),
          o.forEach(function (t, e) {
      ...
      function k(t, e) {
        var n,
          r,
          a = de.createElement("boundelement");
        return (
      ...
      function I(t, e, n, r, a) {
        ...
        $(
          ...
          r.left + o + a[3].width,
          r.top + i + a[0].width,
          r.width - (a[1].width + a[3].width + o + l),
          r.height - (a[0].width + a[2].width + i + s)
        );
      }
      function L(t) {
      ...
      function A(t, e, n, r, a, o, i) {
        e[0] > 0 || e[1] > 0
          ...
          : t.push(["line", o, i]),
          (n[0] > 0 || n[1] > 0) &&
            t.push(["line", a[0].start.x, a[0].start.y]);
      }
      function B(t, e, n, r, a, o, i) {
        ...
        return (
          ...
          n[0] > 0 || n[1] > 0
            ? (l.push(["line", o[0].start.x, o[0].start.y]),
              o[0].curveTo(l),
          ...
          e[0] > 0 || e[1] > 0
            ? (l.push(["line", a[1].end.x, a[1].end.y]),
              a[1].curveToReversed(l))
      ...
      function U(t, e, n) {
        ...
        return {
          ...
          bottomRightInner: be(
            ...
            a + Math.min(m, i + n[0].width),
            Math.max(0, u - n[1].width),
            Math.max(0, h - n[2].width)
      ...
      function V(t, e, n) {
        "transparent" !== n &&
          (t.setVariable("fillStyle", n), F(t, e), t.fill(), (ce += 1));
      }
      function D(t, e, n) {
        var r,
          a,
        ...
        i.forEach(function (e) {
          ...
          (/^(submit|reset|button|text|password)$/.test(t.type) ||
            "SELECT" === t.nodeName) &&
            (o.style.lineHeight = ge(t, "height")),
      ...
      function G(n, r) {
        ...
        if (
          ...
          return (
            ...
            l
              ? (s.src = ue.parseBackgroundImage(o)[0].args[0])
              : (s.innerHTML = o),
            s
          );
        }
      ...
      function Y(t, e, n) {
        for (
          var r,
            a = ge(t, "backgroundImage"),
            o = ue.parseBackgroundImage(a),
            i = o.length;
          i--;
          ...
          if (((a = o[i]), a.args && 0 !== a.args.length)) {
            ...
            (r = M(l)),
              r
                ? _(t, e, n, r, i)
                : ue.log("html2canvas: Error loading background:", a);
          }
      }
      function Q(t, e) {
        if (t.width === e.width && t.height === e.height) return t;
        var n,
          r = de.createElement("canvas");
        return (
          (r.width = e.width),
          (r.height = e.height),
          (n = r.getContext("2d")),
      ...
      function Z(t) {
        var e =
            ge(t, "transform") ||
            ge(t, "-webkit-transform") ||
            ge(t, "-moz-transform") ||
            ge(t, "-ms-transform") ||
            ge(t, "-o-transform"),
          n =
            ge(t, "transform-origin") ||
            ge(t, "-webkit-transform-origin") ||
            ge(t, "-moz-transform-origin") ||
            ge(t, "-ms-transform-origin") ||
            ge(t, "-o-transform-origin") ||
            "0px 0px";
      ...
      function te(t, e, n, r) {
        ...
        return (
          E(t, c, e),
          a.useOverflow === !0 &&
            /(hidden|scroll|auto)/.test(ge(t, "overflow")) === !0 &&
            /(BODY)/i.test(t.nodeName) === !1 &&
            (c.clip = c.clip ? R(c.clip, n) : n),
          c
        );
      }
      function ee(t, e, n) {
      ...
      function re(t, e, n, r) {
        ...
        switch (
          ...
          c.save(),
          c.clip(),
          d.height > 0 && d.width > 0 && !r
            ? (X(c, i, h), Y(t, d, c))
            : r && (l.backgroundColor = h),
          c.restore(),
    ...
    (u.Preload = function (r) {
        ...
        (M.href = e),
          ...
          (t[l] = function (e) {
            "error:" === e.substring(0, 6)
              ? ((i.succeeded = !1), w.numLoaded++, w.numFailed++, o())
              : (p(a, i), (a.src = e)),
              (t[l] = n);
            try {
              delete t[l];
      ...
      function l(e, n) {
        var r = t.getComputedStyle(e, n),
          a = r.content;
        "url" === a.substr(0, 3) &&
          m.loadImage(u.Util.parseBackgroundImage(a)[0].args[0]),
      ...
      function h(t, e) {
        var r;
        u.Util.parseBackgroundImage(t)
          .filter(d)
          .forEach(function (t) {
            "url" === t.method
              ? m.loadImage(t.args[0])
              : t.method.match(/\-?gradient$/) &&
                (r === n && (r = u.Util.Bounds(e)), c(t.value, r));
          });
      }
      function f(t) {
        var e = !1;
        ...
        (e.onload = function () {
          ...
          (e.onerror = function () {
            if (
              ...
              (t.clearTimeout(a.timer), r.proxy)
            ) {
              var l = e.src;
              return (
                (e = new Image()), (a.img = e), (e.src = l), i(e.src, e, a), n
              );
            }
            w.numLoaded++,
              w.numFailed++,
              ...
              t &&
                ...
                t.match(/data:image\/.*;base64,/i)
                  ...
                  ? ((e.crossOrigin = "anonymous"),
                    ...
                    (e.src = t))
                  : r.proxy &&
                    ((o = w[t] = { img: e }), w.numTotal++, i(t, e, o)));
            },
            cleanupDOM: function (a) {
              var i, l;
              if (!w.cleanupDone) {
                a && "string" == typeof a
                  ? x.log("html2canvas: Cleanup because: " + a)
                  : x.log(
          ...
          Object.keys(t)
            ...
            .forEach(function (n) {
              ...
              t[n].forEach(function (t) {
                t.node.zIndex.isPositioned || 1 > t.node.zIndex.opacity
                  ? i.push(t)
    ...
    (t.html2canvas = function (e, n) {
      ...
      return (
        ...
        (o.complete = function (t) {
          ("function" != typeof o.onpreloaded || o.onpreloaded(t) !== !1) &&
            ((r = u.Parse(t, o)),
            ("function" != typeof o.onparsed || o.onparsed(r) !== !1) &&
              ((a = u.Renderer(r, o)),
    ...
    (u.Renderer.Canvas = function (t) {
      ...
      function a(t) {
        if (-1 === l.indexOf(t.arguments[0].src)) {
          ...
          try {
            ...
            return (
              (s = i.createElement("canvas")), (c = s.getContext("2d")), !1
            );
          }
      ...
      return function (t, e, r, a, i) {
        var l,
          ...
          f = t.stack;
        return (
          (h.width = h.style.width = e.width || f.ctx.width),
          (h.height = h.style.height = e.height || f.ctx.height),
          (c = u.fillStyle),
          (u.fillStyle =
            d.isTransparent(f.backgroundColor) && e.background !== n
              ? e.background
              : t.backgroundColor),
